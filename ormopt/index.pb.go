...
func (x *Index) Reset() {
	*x = Index{}
	mi := &file_calque_orm_index_proto_msgTypes[0]
...
var File_calque_orm_index_proto protoreflect.FileDescriptor

const file_calque_orm_index_proto_rawDesc = "" +
	"\n" +
	"\x16calque/orm/index.proto\x12\n" +
	"calque.orm\x1a\x14calque/orm/ref.proto\"\xd3\x01\n" +
	"\x05Index\x12\x1a\n" +
	"\bdisabled\x18\x01 \x01(\bR\bdisabled\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12#\n" +
	"\x04refs\x18\x03 \x03(\v2\x0f.calque.orm.RefR\x04refs\x12\x16\n" +
...
var file_calque_orm_index_proto_goTypes = []any{
	(*Index)(nil), // 0: calque.orm.Index
	(*Ref)(nil),   // 1: calque.orm.Ref
}
var file_calque_orm_index_proto_depIdxs = []int32{
	1, // 0: calque.orm.Index.refs:type_name -> calque.orm.Ref
...
func init() { file_calque_orm_index_proto_init() }
func file_calque_orm_index_proto_init() {
	if File_calque_orm_index_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_calque_orm_index_proto_rawDesc), len(file_calque_orm_index_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_calque_orm_index_proto_goTypes,
		DependencyIndexes: file_calque_orm_index_proto_depIdxs,
		MessageInfos:      file_calque_orm_index_proto_msgTypes,
	}.Build()
	File_calque_orm_index_proto = out.File
	file_calque_orm_index_proto_goTypes = nil
	file_calque_orm_index_proto_depIdxs = nil
}
