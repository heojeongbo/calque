...
func (x *RpcAdd) Reset() {
	*x = RpcAdd{}
	mi := &file_calque_orm_rpc_proto_msgTypes[0]
...
func (x *RpcGet) Reset() {
	*x = RpcGet{}
	mi := &file_calque_orm_rpc_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *RpcPatch) Reset() {
	*x = RpcPatch{}
	mi := &file_calque_orm_rpc_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *RpcErase) Reset() {
	*x = RpcErase{}
	mi := &file_calque_orm_rpc_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_calque_orm_rpc_proto protoreflect.FileDescriptor

const file_calque_orm_rpc_proto_rawDesc = "" +
	"\n" +
	"\x14calque/orm/rpc.proto\x12\n" +
	"calque.orm\"$\n" +
	"\x06RpcAdd\x12\x1a\n" +
...
var file_calque_orm_rpc_proto_goTypes = []any{
	(*RpcAdd)(nil),   // 0: calque.orm.RpcAdd
	(*RpcGet)(nil),   // 1: calque.orm.RpcGet
	(*RpcPatch)(nil), // 2: calque.orm.RpcPatch
	(*RpcErase)(nil), // 3: calque.orm.RpcErase
}
var file_calque_orm_rpc_proto_depIdxs = []int32{
...
func init() { file_calque_orm_rpc_proto_init() }
func file_calque_orm_rpc_proto_init() {
	if File_calque_orm_rpc_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_calque_orm_rpc_proto_rawDesc), len(file_calque_orm_rpc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_calque_orm_rpc_proto_goTypes,
		DependencyIndexes: file_calque_orm_rpc_proto_depIdxs,
		MessageInfos:      file_calque_orm_rpc_proto_msgTypes,
	}.Build()
	File_calque_orm_rpc_proto = out.File
	file_calque_orm_rpc_proto_goTypes = nil
	file_calque_orm_rpc_proto_depIdxs = nil
}
